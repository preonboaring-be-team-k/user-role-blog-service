...
export class AdminBoardController {
    ...
    @Post()
    @ApiOperation({summary: '운영진 게시물 등록 API', description: '운영진이 게시물을 등록한다.'})
    @ApiCreatedResponse({
    ...
    @Get()
    @ApiOperation({summary: '운영진 전체 게시물 조회 API', description: '운영진이 전체 게시물을 조회한다.'})
    @ApiCreatedResponse({
    ...
    @Get('/:id')
    @ApiOperation({summary: '운영진 게시물 조회 API', description: '운영진이 게시물을 조회한다.'})
    @ApiCreatedResponse({
        status: HttpStatus.OK,
        type: BoardResponseDto
    })
    ...
    @Put('/:id')
    @ApiOperation({summary: '운영진 게시물 수정 API', description: '운영진이 게시물을 수정한다.'})
    @ApiCreatedResponse({
        status: HttpStatus.OK,
        type: BoardResponseDto
    })
    ...
    @Delete('/:id')
    @ApiOperation({summary: '운영진 게시물 삭제 API', description: '운영진이 게시물을 삭제한다.'})
    @ApiCreatedResponse({
        status: HttpStatus.OK,
    })
